...
VALUES (@StartDate, @EndDate, @Price, @FrameNrCar, @Customer, @Status, @ReviewedBy)";
                    using (var command = connection.CreateCommand())
                    {
                        ...
                        reviewedByParam.Value = DBNull.Value; // Default waarde voor een nieuwe aanvraag
                    ...
                    string carColor = await _vehicleRepo.GetVehicleColorAsync(int.Parse(rentalRequest.FrameNrCar));
